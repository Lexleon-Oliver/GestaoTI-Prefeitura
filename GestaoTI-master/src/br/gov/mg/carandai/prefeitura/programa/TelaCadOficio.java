...
public class TelaCadOficio extends javax.swing.JInternalFrame {


    
    
    public TelaCadOficio() throws ClassNotFoundException {
        initComponents();
        
    }
    
    public void limparCampos(){
         CampoNumOfic.setText("");
         CampoAssunt.setText("");
         CampoData.setText("");
         CampoDest.setText("");
         CampoNumOfic2.setSelectedIndex(-1);
         CampoRemet.setText("");
    }
    ...
    private void initComponents() {
        ...
        CampoNumOfic = new javax.swing.JFormattedTextField();
        jLabel10 = new javax.swing.JLabel();
        CampoNumOfic2 = new javax.swing.JComboBox<>();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastro de Ofício", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 16))); // NOI18N
        ...
        jLabel1.setText("Número do Ofício:");
        ...
        CampoNumOfic.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));

        jLabel10.setText("/ ");

        CampoNumOfic2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2020", "2021", "2022", "2023" }));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(CampoNumOfic, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jLabel10)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(CampoNumOfic2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(CampoNumOfic, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel10)
                    .addComponent(CampoNumOfic2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel9)
    ...
    private void BotaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoSalvarActionPerformed
       if("".equals(CampoNumOfic.getText())) {
            ...
            if(JOptionPane.showConfirmDialog(null, "Deseja salvar o registro?","Confirmar Cadastro!",JOptionPane.YES_NO_OPTION)== 0){
                Oficio ofic = new Oficio();
                OficioDAO dao = new OficioDAO();
                ofic.setNumOfic(CampoNumOfic.getText());
                ofic.setAnoOfic(CampoNumOfic2.getSelectedItem().toString());
                ofic.setData(CampoData.getText());
                ofic.setDe(CampoRemet.getText().toUpperCase());
                ofic.setPara(CampoDest.getText().toUpperCase());
                ofic.setAssunto(CampoAssunt.getText().toUpperCase());
                try {
                    dao.adicionar(ofic);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(TelaCadOficio.class.getName()).log(Level.SEVERE, null, ex);
                }
                limparCampos();
            }else{
                CampoNumOfic.requestFocus();
    ...
    private javax.swing.JFormattedTextField CampoNumOfic;
    private javax.swing.JComboBox<String> CampoNumOfic2;
