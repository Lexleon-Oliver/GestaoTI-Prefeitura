...
public class TelaEditImpressora extends javax.swing.JInternalFrame {

    
    
    
    public TelaEditImpressora(String NumSerie) throws ClassNotFoundException {
        initComponents();
        
        Impressora imp =new Impressora();
        imp = ImpressoraDAO.listarPorNumeroDeSerie(NumSerie);
        this.preeencherCampos(imp);
    }
    
    public void preeencherCampos(Impressora imp) throws ClassNotFoundException{
        
        CampoNome.setText(imp.getNome());
        CampoMarca.setText(imp.getMarca());
        CampoModelo.setText(imp.getModelo());
        CampoNumSerie.setText(imp.getNumserie());
        CampoAndar.setSelectedIndex(Integer.parseInt(imp.getAndar()));
        CampoMAC.setText(imp.getMac());
        CampoDepartamento.setText(imp.getDepartamento());
        CampoLogin.setText(imp.getLogin());
        CampoSenha.setText(imp.getSenha());
        CampoIP.setText(imp.getIp());
        CampoPrefSim.setSelected(imp.isPrefeitura());
        CampoPrefNao.setSelected(!imp.isPrefeitura());
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Alteração de Impressora", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 16))); // NOI18N
       ...
       if("".equals(CampoNome.getText())) {
           ...
           CampoIP.requestFocus();
            ...
            try {
                ...
                Logger.getLogger(TelaEditImpressora.class.getName()).log(Level.SEVERE, null, ex);
            }
            }else{
                CampoNome.requestFocus();
            }
