...
public class TelaEditServidor extends javax.swing.JInternalFrame {

    
    
    
    public TelaEditServidor(String mac) throws ClassNotFoundException {
        initComponents();
        
        Servidor serv =new Servidor();
        serv = ServidorDAO.editarPorNumeroDeMac(mac);
        this.preencherCampos(serv);
    }
    
    public void preencherCampos(Servidor serv){
        CampoNome.setText(serv.getNome());
        CampoSenhaBios.setText(serv.getSenhabios());
        CampoSO.setText(serv.getSo());
        CampoSenha.setText(serv.getSenha());
        CampoLogin.setText(serv.getLogin());    
        CampoIP.setText(serv.getIp());
        CampoMAC.setText(serv.getMac());
        CampoMAC2.setText(serv.getMac2());
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Alteração de Servidor", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 16))); // NOI18N
