...
public class TelaEditComputador extends javax.swing.JInternalFrame {

    
    
    
    public TelaEditComputador(String mac) throws ClassNotFoundException {
        initComponents();
        Computador comp =new Computador();
        comp = ComputadorDAO.listarPorMac(mac);
        this.preeencherCampos(comp);
    }
    
    public void preeencherCampos(Computador comp) throws ClassNotFoundException{
        
        CampoNome.setText(comp.getNome());
        CampoGrupoTrab.setText(comp.getGrupotrab());
        //CampoSO.setSelectedItem(comp.getSo());
        CampoSO.setSelectedItem(comp.getSo());
        CampoFormatacao.setText(comp.getFormatacao());
        CampoSerial.setText(comp.getSerial());
        CampoIP.setText(comp.getIp());
        CampoPrefSim.setSelected(comp.isPrefeitura());
        CampoPrefNao.setSelected(!comp.isPrefeitura());
        CampoAndar.setSelectedItem(comp.getAndar());
        CampoUsuario.setText(comp.getUsuario());
        CampoCorBranco.setSelected(comp.isCorbranco());
        CampoCorPreto.setSelected(comp.isCorpreto());
        CampoCorPrata.setSelected(comp.isCorprata());
        CampoCorCinza.setSelected(comp.isCorcinza());
        CampoDepartamento.setText(comp.getDepartamento());
        CampoNumBaia.setSelectedItem(comp.getNumbaia());
        CampoModelPMae.setText(comp.getModeloplacamae());
        CampoMarcaPMae.setText(comp.getMarcaplacamae());
        CampoMAC.setText(comp.getMac());
        CampoMarcaProcessador.setText(comp.getMarcaprocessador());
        CampoModelProc.setText(comp.getModeloprocessador());
        CampoFreqproc.setSelectedItem(comp.getFreqprocessador());
        CampoCpMem.setSelectedItem(comp.getCapacidadememoria());
        CampoModelMem.setSelectedItem(comp.getModelomemoria());
        CampoFreqMem.setSelectedItem(comp.getFreqmemoria());
        CampoCapHD.setSelectedItem(comp.getCapacidadehd());
        CampoModelHD.setSelectedItem(comp.getModelohd());
        CampoDriveSim.setSelected(comp.isDrive());
        CampoDriveNao.setSelected(!comp.isDrive());
        CampoModelDrive.setSelectedItem(comp.getModelodrive());
    ...
    public void limparCampos(){
        ...
        CampoNumBaia.setSelectedIndex(-1);
    ...
    private void initComponents() {
        ...
        CampoNumBaia = new javax.swing.JComboBox<>();

        setClosable(true);
        setTitle("Setor de Informática");
        setToolTipText("");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Alteração de Computador", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 16))); // NOI18N
        ...
        CampoNumBaia.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3", "4" }));
        CampoNumBaia.setSelectedIndex(-1);
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(CampoAndar, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(CampoNumBaia, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jLabel12)
                            .addComponent(CampoNumBaia, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(CampoCorBranco)
                            .addComponent(CampoCorPrata))
      ...
      if("".equals(CampoNome.getText())) {
           ...
           CampoModelDrive.requestFocus();
            ...
            try {
                ...
                comp.setSo(CampoSO.getSelectedItem().toString().toUpperCase());
                ...
                comp.setNumbaia(CampoNumBaia.getSelectedItem().toString());
                ...
                compdao.atualizar(comp);
                limparCampos();

            } catch (ClassNotFoundException ex) {
                Logger.getLogger(TelaEditComputador.class.getName()).log(Level.SEVERE, null, ex);
            }
            }else{
                CampoNome.requestFocus();
            }
    ...
    private javax.swing.JComboBox<String> CampoNumBaia;
